...
Two applications were designed and implemented as prototypes: (1) the requirements engineering decision support system TOREOnto~\citep{toreonto} and (2) the knowledge exploration and navigation visualization CIONo~\citep{ciono}.\todo{add ciono to bib}
...
The graph is visualized using the Cytoscape.js~\citep{cytoscape} library with the spring-based Euler layout\todo{cite?}.
