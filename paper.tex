...
After the transformation~\citep{sniktec} of the spreadsheets using Tarql, the resulting RDF was refined in Protege and then uploaded to a Virtuoso SPARQL endpoint. 
Besides issues of collaborative editing, this required a regular export and reupload, which delayed the effect of changes in SNIK to the user facing applications.
