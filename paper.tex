...
In order to integrate different knowledge sources and to provide the knowledge in a structured, machine-readable data format, we extracted knowledge about HIS management from three textbooks~\citep{bb,ob,he} and other sources, see \cref{tab:source}.
...
Ontology Documentation	&\url{https://snikproject.github.io/ontology/}\\
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{img/combine.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\linewidth]{img/strategic-im.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\linewidth]{img/spiderworm.pdf}
